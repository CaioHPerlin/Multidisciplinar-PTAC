...
export default function Navbar() {
  return (
    <nav className="border-gray-200 bg-red-700">
      <div className="p-7 flex flex-wrap justify-between items-center">
      <Link href="/">
        <Image
    ...
    <label for="searchbar" class="sr-only">Pesquisar</label>
    <div className="relative w-full">
        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            <svg aria-hidden="true" className="w-5 h-5 text-white" fill="currentColor"><path d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
        </div>
