        ...
        <div className="w-3/4 m-10 bg-red-700 p-4 rounded grid grid-cols-2 justify-items-center">
          ...
          <div className="m-10 justfiy-items-start rounded overflow-hidden bg-red-700 ">
            ...
            <div className="grid grid-cols-5 gap-4 font-bold rounded">
              <button className="border-red-600 border-2 py-2 px-4 hover:border-red-500">
                PP
              </button>
              <button className="border-red-600 border-2 py-2 px-4 hover:border-red-500">
                P
            ...
            <div className="my-20 grid grid-cols-2 gap-8">
              <button className="bg-red-600 hover:bg-red-500 font-bold py-2 px-4 rounded">
                Alterar
              </button>
              <button onClick={handleDelete} className="bg-red-600 hover:bg-red-500 font-bold py-2 px-4 rounded">
                Deletar
              </button>
            </div>
          </div>
